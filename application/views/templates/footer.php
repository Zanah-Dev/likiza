    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="" target="_blank">DBota</a>'; break;
                  default : echo '<a class="anchor" href="" target="_blank">DBota</a>'; break;
              } ?>
          &nbsp;v<?php echo $GLOBALS['versionOfJorani'];?>&nbsp;&copy;2021 Diana Bota // Project
        </div>
    </div>
    </div>
